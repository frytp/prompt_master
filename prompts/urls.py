...
urlpatterns = [
    ...
    path('prompt/<int:pk>/variables/', views.ProcessPromptVariablesView.as_view(), name='prompt_variables'),
    path('prompt/<int:pk>/increment/', views.IncrementUsageView.as_view(), name='prompt_increment'),
    path('prompt/<int:pk>/toggle-favorite/', views.ToggleFavoriteView.as_view(), name='prompt_toggle_favorite'),
    ...
    path('import/', views.ImportPromptsView.as_view(), name='prompt_import'),
    path('statistics/', views.PromptStatisticsView.as_view(), name='prompt_statistics'),
    path('api/prompt/<int:pk>/content/', views.GetPromptContentView.as_view(), name='api_prompt_content'),
]